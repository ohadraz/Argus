...
Covers the adapter behind the Postmortem's revenue port: what it counts as
revenue over a window, that it answers in the currencies the shop was paid in,
and that the payment provider's vocabulary and credential stop at it.
