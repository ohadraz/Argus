# responder-rate-source

## Purpose

Covers the adapter behind the Postmortem's pay-band port: that a title's
worth comes from a compensation level's band rather than from anybody's
salary, and that the HR system's vocabulary and credential stop at it.
