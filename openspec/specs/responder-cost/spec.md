...
Covers what an incident's response cost: the minutes each responder spent,
priced at the pay band of the title they held, and the range that figure
carries because a band is a range.
