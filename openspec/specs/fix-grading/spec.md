# fix-grading Specification

## Purpose
Whether a recorded Code-Fix patch actually works, decided by running the Target Service own tests against it. Code-Fix proposes statically and never learns; this is the only thing that finds out, and it spends nothing to do so.
## Requirements
