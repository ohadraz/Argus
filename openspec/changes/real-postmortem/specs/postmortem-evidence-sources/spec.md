...
as an amount and its currency, without naming any payment provider above the
port. The port SHALL NOT take a service argument: revenue is account-wide, and
narrowing it to the affected path is what the estimate's weight already does.
