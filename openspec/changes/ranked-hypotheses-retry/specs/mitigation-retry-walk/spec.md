...
Every attempt SHALL mark its candidate as tested and record what the attempt did. The incident's timeline SHALL show which candidates were tried, in what order, and with what result.
