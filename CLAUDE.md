...
- `modules/common/` - shared library (schemas, MCP client wrapper, LLM client, logging, config). Other modules depend on it via `{ workspace = true }` in their `pyproject.toml`.
